...
$app->post('/api/Postmark/sendEmail', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['serverToken','from','to']);
    ...
    $requiredParams = ['serverToken'=>'serverToken','from'=>'From','to'=>'To'];
    ...
    $bodyParams = [
       'json' => ['From','To','Cc','Bcc','Subject','Tag','HtmlBody','TextBody','ReplyTo','Headers','TrackOpens','TrackLinks','Attachments']
    ];
