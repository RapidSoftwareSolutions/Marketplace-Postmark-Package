...
$app->post('/api/Postmark/updateServerForAccount', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['accountToken','serverId']);
    ...
    $requiredParams = ['accountToken'=>'accountToken','serverId'=>'serverId'];
    ...
    $query_str = "https://api.postmarkapp.com/servers/{$data['serverId']}";
