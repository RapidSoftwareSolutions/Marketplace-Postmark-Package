...
$app->post('/api/Postmark/getOutboundMessage', function ($request, $response) {
    ...
    $optionalParams = ['recipient'=>'recipient','fromEmail'=>'fromemail','recipient'=>'recipient','tag'=>'tag','status'=>'status','fromDate'=>'fromdate','toDate'=>'todate'];
    $bodyParams = [
       'query' => ['count','offset','recipient','fromemail','tag','status','todate','fromdate']
    ];
